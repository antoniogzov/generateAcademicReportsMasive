...
include_once dirname(__DIR__ . '', 2) . "/models/academicLevelReport/modelPrimaryBangHebrewMales.php";
...
function getBangMalesHebPrimSR()
{
    $response = array();
    ...
    $model_heb = new DataSchoolReportCardsHebrewMales;
