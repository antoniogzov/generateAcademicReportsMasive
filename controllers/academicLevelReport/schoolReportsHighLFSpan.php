...
include_once dirname(__DIR__ . '', 2) . "/models/academicLevelReport/modelHighLafSpanish.php";
...
function getLafMalesSpanHighSR()
{
    ...
    $model_span = new DataSchoolReportCardsLafontine;
    ...
    foreach ($array_groups_span as $group_span) {
        ...
        $array_languages = $model_span->getAssignmentByGroupLanguage($group_span->id_group, $id_academic_area, $order_by_lang);
        ...
        foreach ($students as $index) {
            ...
            $getSpecialityGroup = $model_span->getSpecialityGroup($index->id_student);
            ...
            foreach ($periods_span as $p_h) {
                ...
                $array_conductual = $model_span->getQualificationsCondByStudentPeriodSpan($group_span->id_group, $id_academic_area, $index->id_student, $p_h->id_period_calendar, $order_by_cond_span);
