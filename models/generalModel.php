...
class generalModelReports extends Connection
{
    ...
    public function getBaseGroupInformation($id_group)
    {
        ...
        $query = $this->conn->query("SELECT groups.id_group,groups.group_code,groups.hebrew_group, aclvg.degree,CONCAT (colab.apellido_paterno_colaborador, ' ', colab.apellido_materno_colaborador, ' ', colab.nombres_colaborador) AS tutor_name
