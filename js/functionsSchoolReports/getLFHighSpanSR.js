async function getLFHighSpanSR(data) {
  for (let i_group = 0; i_group < data.groups_span.length; i_group++) {
    ...
    for (
      let ind_std = 0;
      ind_std < data.groups_span[i_group].students[0].length;
      ind_std++
    ) {
      ...
      var student_code =
        data.groups_span[i_group].students[0][ind_std].student.student_code;
      var student_name =
        data.groups_span[i_group].students[0][ind_std].student.student_name;
      var student_hebrew_name =
        data.groups_span[i_group].students[0][ind_std].student.hebrew_name;
      ...
      for (
        ...
        assignment = [];
        for (
          let period_qualifs = 0;
          period_qualifs <
          array_all_periods_span_qualifications[assignment_period]
            .spanish_period_qualifications.length;
          period_qualifs++
        ) {
          name_subject =
            array_all_periods_span_qualifications[assignment_period]
              .spanish_period_qualifications[period_qualifs].name_subject;
          spanish_name_teacher =
            array_all_periods_span_qualifications[assignment_period]
              .spanish_period_qualifications[period_qualifs]
              .spanish_name_teacher;
          var subject_type = "GENERAL";
            if(array_all_periods_span_qualifications[assignment_period]
              .spanish_period_qualifications[period_qualifs].group_type_id == 2){
                subject_type = "ESPECIALIDAD";
              }
          var pases_lista =
            array_all_periods_span_qualifications[assignment_period]
              .spanish_period_qualifications[period_qualifs].pases_lista;
          var faltas =
            array_all_periods_span_qualifications[assignment_period]
              .spanish_period_qualifications[period_qualifs].faltas;
      ...
      for (
        ...
        for (
          ...
          console.log(
            array_all_periods_span_qualifications[assignment_period]
              .spanish_period_qualifications[period_qualifs].no_period
          );
          var calificacion = "-";
          if (
            array_all_periods_span_qualifications[assignment_period]
              .spanish_period_qualifications[period_qualifs].calificacion !=
              "" ||
            array_all_periods_span_qualifications[assignment_period]
              .spanish_period_qualifications[period_qualifs].calificacion !=
              undefined
      ...
      doc.autoTable({
        ...
        body: [
          [
            {
              content:
                "*Para pasar a 5° de preparatoria no deberás acumular más de 4 materias reprobadas pues de hacerlo tendrás que repetir año. \n Recuerda que de reprobar Español también repruebas Hebreo.",
