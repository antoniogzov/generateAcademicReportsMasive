  ...
  $(".generateGroupReports").click(function () {
    ...
    switch (id_level_combination) {
      ...
      case "5":
        ...
        //--- --- ---//
        $.ajax({
          url: "controllers/academicLevelReport/schoolReportsPrimBangHebMales.php",
          method: "POST",
          data: {
            fun: "getBangMalesHebPrimSR",
            id_level_combination: id_level_combination,
            id_group: id_group,
            id_academic_area: id_academic_area,
            order_by_lang: "ORDER BY sbj.name_subject",
      ...
      case "7":
        ...
        break;
      case "14":
        console.log("getLafMalesSpanMiddleSR()");
        //--- --- ---//
        $.ajax({
          url: "controllers/academicLevelReport/schoolReportsMiddleLFSpan.php",
          method: "POST",
          data: {
            fun: "getLafMalesSpanMiddleSR",
            id_level_combination: id_level_combination,
            id_group: id_group,
            id_academic_area: id_academic_area,
            order_by_lang: "ORDER BY sbj.name_subject",
          ...
          .done(function (data) {
            ...
            if (data.response) {
              ...
              console.log(response_data);
              //--- --- ---//
              var logo_url = "imgs/sec_prepa_varones.jpg";
              getImgFromUrl(logo_url, function (img, data) {
                getSchoolReportCardSpanishSecondaryMalesLFT(img, response_data);
              });
              Swal.close();
              //--- --- ---//
            } else {
        ...
        $.ajax({
          ...
          .done(function (data) {
            ...
            if (data.response) {
              ...
              var logo_url = "imgs/sec_prepa_varones.jpg";
              getImgFromUrl(logo_url, function (img, data) {
                getLFHighSpanSR(img, response_data);
              });
              Swal.close();
              //--- --- ---//
            } else {
