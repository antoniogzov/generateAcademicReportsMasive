$(document).ready(function() {
    $("#slct_academic_area").change(function() {
        ...
        $("#slct_campus").html('<option value="0" selected disabled>Elija una opción</option>');
    ...
    $("#slct_academic_level").change(function() {
        ...
        $.ajax({
            ...
            if (data.response == true) {
                html_options = "";
                html_options += '<option value="0" selected disabled>Elija una opción</option>';
    ...
    //--- --- ---//
    if (document.getElementById("groupsTable") != 'undefined' && document.getElementById("groupsTable") != null) {
